...
vkInit::SwapChainSupportDetails vkInit::query_swapchain_details(const vk::PhysicalDevice& device, vk::SurfaceKHR& surface, bool debug)
{
...
vkInit::SwapChainBundle vkInit::create_swapchain(vk::Device logicalDevice, vk::PhysicalDevice device, vk::SurfaceKHR surface, int width, int height, bool debug)
{
