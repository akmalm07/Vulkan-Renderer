...
vk::Device vkInit::create_logical_device(vk::PhysicalDevice& device, vk::SurfaceKHR& surface, bool debug)
{
	...
	(
		...
		cast_uint32(queueInfo.size()),
		queueInfo.data(),
		cast_uint32(enabledLayers.size()),
		enabledLayers.data(),
		cast_uint32(deviceExtensions.size()),
...
bool vkInit::is_device_suitable(vk::PhysicalDevice& device, bool debug)
{
...
bool vkInit::check_device_extension_support(const vk::PhysicalDevice& device, const std::vector<const char*>& extensions, bool debug)
{
