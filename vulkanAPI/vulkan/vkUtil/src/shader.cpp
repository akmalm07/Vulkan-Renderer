...
std::vector<char> vkInit::read_file(std::filesystem::path& path, bool debug)
{
...
vk::ShaderModule vkInit::create_shader_module(std::filesystem::path& path, vk::Device logicalDevice, bool debug)
{
